...
var LaCrosseDTH, LaCrosseDTT, LaCrosseBMP180, emonTH, emonWater;

module.exports = function(homebridge) {
    LaCrosseDTH    = require('./jeelink/LaCrosseDTH.js')(homebridge);
    LaCrosseDTT    = require('./jeelink/LaCrosseDTH.js')(homebridge);
...
function JeeLinkParser( platform ) {
    ...
    this.logLaCrosseDTT = new LaCrosseDTT( platform );
    ...
    configure: function( device ) {
        switch( device.context.type ) {
            case this.logLaCrosseDTH.type:
                ...
                break;
            case this.logLaCrosseDTT.type:
                return this.logLaCrosseDTT.configure( device );
                break;
/*
...
*/
            default:
                this.log.error('Device type not yet implemented!');
        }
    },
    test: function() {
        // Some Tests!!!
