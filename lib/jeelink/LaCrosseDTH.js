...
//    setInterval(this.update.bind(this), 5000);
    ...
    this.addService(Service.TemperatureSensor, this.name).getCharacteristic(Characteristic.CurrentTemperature)
...
LaCrosseDTHSensor.prototype.update = function() {
    ...
    // TemperatureSensor
    this.getCurrentTemperature(function(foo, data) {
        debug( "update current Temperature: " + foo + " " + data.temperature  );
        this
