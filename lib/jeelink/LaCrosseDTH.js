...
LaCrosseDTH.prototype = {
    parseValue: function( data ) {
        ...
        var data = {
            ...
            newBat:         ((buf.readUInt8(1) & 0x80) >> 7),       // wenn "100000xx" dann NewBatt # xx = SensorType 1 oder 2
            lowBat:         ((buf.readUInt8(4) & 0x80) >> 7),       // Hier muss noch "incl. WeakBatteryFlag" ausgewertet 
            temperature:    temp,
            humidity:       (buf.readUInt8(4) & 0x7f),
