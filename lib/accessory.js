...
/*
    try {
        if ( Object.getPrototypeOf(deviceID), Object.getPrototypeOf(deviceID) === Accessory.prototype ) {
            platform.log.debug( "The device is already an accessory." );
            // Accessory.apply(deviceID, [ deviceID.displayName, deviceID.UUID ]);
            return this.configure( platform, deviceID );
        }
    } catch( e ) {
...
//    this.getServices = JeeLinkAccessory.prototype.getServices;
